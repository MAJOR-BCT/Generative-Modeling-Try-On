...
if __name__ == '__main__':
    ...
    parser.add_argument('--depth_root', type=str, default='/final-depth',help='path to the DRM result')
    parser.add_argument('--frgb_root', type=str, default='/tryon',help='path to the TFM result (front rgb)')
    ...
    parser.add_argument('--parse_root', type=str, default='dataset/image-parse',help='path to the parsing image')
    parser.add_argument('--point_dst', type=str, default='test_pairs',help='path to output dir for point cloud')
